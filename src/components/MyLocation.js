...
export const MyLocation = ({position, setPosition}) => {
  ...
  return (
    ...
    {city === "" || city ===undefined ? (
        ...
        <button onClick={cityName} type="button" className="text-white bg-gray-800 hover:bg-gray-300 focus:ring-4 focus:outline-none focus:ring-gray-500 dark:focus:ring-gray-800 font-medium rounded-lg text-sm  mt-4 px-5 py-2.5 text-center me-2 mb-2">Know your location</button>
      ) : (
        <p>{city} </p>
    )}
